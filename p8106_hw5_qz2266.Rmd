...
- With cross-validation, we find the optimal tuning parameter is when cost is 1.535063, which minimizes the error.
...
- The training error rate for the support vector machine is (1-0.9783)x100% = 2.17%. The test error rate is (1-0.9138)x100% = 8.62%.



## Question 2

We perform hierarchical clustering on the states using the USArrests data in the ISLR package.
